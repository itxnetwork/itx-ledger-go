module github.com/itxnetwork/itx-ledger-go
...
require (
	...
	github.com/itxnetwork/itx/v12 v12.0.0-20230310230306-719363fbb92f
...
replace (
	github.com/cosmos/cosmos-sdk => github.com/itxnetwork/cosmos-sdk v0.46.11-ledger
